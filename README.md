...
- **Costo Operativo**: aquí es donde se registran los datos.
  ...
  - Estos registros (horas trabajadas y otros gastos operativos) también aparecen automáticamente en la pestaña **Gastos** y se incluyen en los totales de **Reportes**, junto con las facturas de proveedores.
- **Reportes**: elige un período (o usa los atajos "Este mes", "Mes pasado", "Este año", "Todo") y consulta el total general (gastos + costo operativo combinados), el desglose por proveedor/concepto y el desglose por "Pagado por"/categoría (Mano de obra, Costo operativo, o el valor de "Pagado por" que hayas usado).
